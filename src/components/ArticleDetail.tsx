  ...
  return (
    <div className="py-32 space-y-16 animate-in fade-in duration-700 max-w-4xl mx-auto">
      ...
      <div className="relative py-20">
         ...
         <div className="text-2xl md:text-3xl text-washi/80 leading-relaxed font-light space-y-12 whitespace-pre-wrap first-letter:text-7xl first-letter:font-black first-letter:text-cinnabar first-letter:float-left first-letter:mr-4 first-letter:mt-2">

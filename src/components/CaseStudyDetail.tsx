    ...
    <div className="py-32 space-y-24 animate-in fade-in duration-700">
      ...
      <div className="h-[60vh] relative overflow-hidden border-y border-woodblock">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
           <div className="bg-sumi/80 backdrop-blur p-12 max-w-2xl border-l-8 border-cinnabar">
             ...
             <div className="text-xl md:text-2xl text-washi font-light leading-relaxed space-y-4">
      ...
      <div className="max-w-4xl mx-auto space-y-32">
        ...
        <section className="space-y-12">
          ...
          <div className="text-2xl text-washi/70 leading-relaxed space-y-8 font-light">
        ...
        <section className="space-y-12 bg-woodblock/10 p-12 border-l-4 border-cinnabar">
          ...
          <div className="text-2xl text-washi leading-relaxed space-y-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-12">
           ...
           <div className="md:col-span-8 text-xl text-washi/60 leading-relaxed space-y-6">
             {study.methodology.map((p, i) => <p key={i}>{p}</p>)}
           </div>
        </section>
        ...
        <div className="space-y-16 border-t border-woodblock pt-16">
          <div className="space-y-8">
             ...
             <div className="text-2xl text-washi/80 leading-relaxed space-y-8 font-light">
               {study.results.map((p, i) => <p key={i}>{p}</p>)}
             </div>
          </div>
        </div>
        ...
        <div className="bg-cinnabar p-16 space-y-8">
           ...
           <div className="text-2xl text-washi/90 leading-relaxed space-y-6">
             {study.conclusion.map((p, i) => <p key={i}>{p}</p>)}
           </div>
        </div>

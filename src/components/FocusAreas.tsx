  ...
  return (
    <section id="focus" className="space-y-10 sm:space-y-12 md:space-y-16">
      <div className="flex flex-col md:flex-row items-end justify-between gap-4 sm:gap-6 md:gap-8 border-b border-woodblock pb-6 sm:pb-8">
        <div
          className="flex justify-between items-center w-full md:w-auto cursor-pointer md:cursor-default"
        ...
        >
          ...
          <div className="md:hidden text-cinnabar ml-2">
            {isExpanded ? (
      ...
      <div className={`${isExpanded ? 'grid' : 'hidden'} md:grid grid-cols-1 md:grid-cols-2 gap-px bg-woodblock`}>
        {areas.map((area, i) => (

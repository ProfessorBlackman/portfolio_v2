    ...
    <section id="experience" className="space-y-8 sm:space-y-10 md:space-y-12">
      ...
      <div className="space-y-6 sm:space-y-8">
        {displayExperiences.map((exp, idx) => (
          <div key={exp._id} className={`group relative bg-woodblock/20 p-4 sm:p-5 md:p-6 lg:p-8 border-l-2 transition-all duration-300 hover:bg-woodblock/40 ${idx % 2 === 0 ? 'border-cinnabar md:mr-8 lg:mr-12' : 'border-indigo md:ml-8 lg:ml-12'}`}>

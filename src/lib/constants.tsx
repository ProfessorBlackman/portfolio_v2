...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: ['In distributed systems, time is a lie. Between clock drift, leap seconds, and NTP adjustments, you can never truly rely on two machines having the same "now". This article explores monotonic vs wall-clock time, and why your timeout logic might be broken if you are using the wrong one.'],
...
export const SKILLS: Skill[] = [
  { _id: 's1', name: 'Java', proficiency: 90, category: 'backend' },
  { _id: 's2', name: 'Python', proficiency: 85, category: 'backend' },
  { _id: 's3', name: 'TypeScript', proficiency: 88, category: 'languages' },
  { _id: 's4', name: 'Spring Boot', proficiency: 80, category: 'backend' },
  { _id: 's5', name: 'Flutter', proficiency: 75, category: 'mobile' },
  { _id: 's6', name: 'SQL/NoSQL', proficiency: 85, category: 'databases' }
];
